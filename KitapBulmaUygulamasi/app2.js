...
let kitap3 = {
  isim: "Belki Bir Gün Uçarız",
  yazar: "Aylin Balboa",
  fiyat: 80,
  raf :"4.5 RAF"
};
let kitap4 = {
  isim: "Ben Orada Değildim Üstelik Siz de Yoktunuz",
  yazar: "Burak Aksak",
  fiyat: 72,
  raf : "5.2 RAF"
};
...
function kodBul(kitapİsmi){
    ...
    kitaplar.forEach(function(kitap){
        if(kitap.isim.toLocaleUpperCase().includes(kitapİsmi.toLocaleUpperCase(),0)){
            rafKod=kitap.raf
        }
    })
    return rafKod;
